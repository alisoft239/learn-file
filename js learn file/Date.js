...
// #--------------Track Operations Time---------163---


/*
  Date And Time
  - Track Operations Time
  ازاي تقيس الوقت اللي خدته عمليه معينه
  Search
  - performance.now()
  {
  (قياس زمن تنفيذ كود)
  ...
  مقارنة خوارزميات
  أداء الأنيميشن
  لا تستخدمها لعرض وقت للمستخدم
ممتازة لـ profiling و debugging
مدعومة في كل المتصفحات الحديثة
أسرع وأدق أداة لقياس الزمن في JS
  }
  - performance.mark()
*/
