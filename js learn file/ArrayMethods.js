/*
  ...
  Array.from() هي طريقة لتحويل أي شيء يشبه المصفوفة (array-like) أو أي Iterable إلى مصفوفة حقيقية (Array).
*/
...
/*
  Array Methods
  - Array.copyWithin(Target, Start => Optional, End => Optional) (النهاية - البداية - المكان)
...
*/
// بتعمل استخراج للعناصر او بترجعها مفصفصه عشان تعرف تتعامل معاها كانها عناصر انت ضايفها
